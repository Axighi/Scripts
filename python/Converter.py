...
f=open(file)
longtitudeColumn = open("longtitude.txt", 'w')
latitudeColumn = open("latitude.txt", 'w')
lines = f.readlines()
for i in range(len(lines)):
  if lines[i] == "\n":
    longtitudeColumn.write('\n')
    latitudeColumn.write('\n')
  else:
    ...
    longtitudeColumn.write(convertedLongtitude)
    latitudeColumn.write(convertedLatitude)
longtitudeColumn.close()
latitudeColumn.close()
f.close()
